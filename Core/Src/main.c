...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
    ...
    /* USER CODE BEGIN 3 */
		...
		statusGyro = HAL_I2C_IsDeviceReady(&hi2c1, gyroAddress, 1, 1000);
		statusMag = HAL_I2C_IsDeviceReady(&hi2c1, magAddress, 1, 1000);
		HAL_I2C_Mem_Read(&hi2c1, gyroAddress, gyroRegister, 1, &gyroData[0], 1, 1000);
		HAL_I2C_Mem_Read(&hi2c1, magAddress, magRegister, 1, &magData[0], 1, 1000);
		HAL_Delay(500);
	}
  /* USER CODE END 3 */
}
